...
We found another such attractor at ![a=1.04; \\; b =
.51933](https://s0.wp.com/latex.php?latex=a%3D1.04%3B+%5C%3B+b+%3D+.51933&bg=ffffff&fg=333333&s=0
"a=1.04; \\; b = .51933") where zero converges on to the attractor by
the 6th iteration. Sprott reported a very similar attractor at ![a=1;
\\; b =
0.5427](https://s0.wp.com/latex.php?latex=a%3D1%3B+%5C%3B+b+%3D+0.5427&bg=ffffff&fg=333333&s=0
"a=1; \\; b = 0.5427").

![henon\_parabolic2](https://manasataramgini.files.wordpress.com/2016/12/henon_parabolic2.png?w=640)Figure
2

These strange attractors are not the most aesthetic nor very “rich” in
structure. However, there are some other aesthetically more appealing
behaviors seen in this map. For values of slightly greater than
![b=-1](https://s0.wp.com/latex.php?latex=b%3D-1&bg=ffffff&fg=333333&s=0
"b=-1") e.g. (![a=.8; \\;
b=-.9999](https://s0.wp.com/latex.php?latex=a%3D.8%3B+%5C%3B+b%3D-.9999&bg=ffffff&fg=333333&s=0
"a=.8; \\; b=-.9999")) zero evolves very gradually towards a single
point attractor. In the process we get an interesting map where the
evolving points revolve in the triangular region between the three
points
![(0,0);(1,0);(0,-1)](https://s0.wp.com/latex.php?latex=%280%2C0%29%3B%281%2C0%29%3B%280%2C-1%29&bg=ffffff&fg=333333&s=0
"(0,0);(1,0);(0,-1)") in smaller and smaller cycles. The map shows a
banded appearance due to greater or lesser permissive regions. At
![a=.8; \\;
b=-1](https://s0.wp.com/latex.php?latex=a%3D.8%3B+%5C%3B+b%3D-1&bg=ffffff&fg=333333&s=0
"a=.8; \\; b=-1") the attractor becomes a closed curve forming the limit
cycle of the earlier earlier attractor (in blue). The lower point of
intersection of the parabola
![x=1-ax^2+y](https://s0.wp.com/latex.php?latex=x%3D1-ax%5E2%2By&bg=ffffff&fg=333333&s=0
"x=1-ax^2+y") and the line
![y=bx](https://s0.wp.com/latex.php?latex=y%3Dbx&bg=ffffff&fg=333333&s=0
"y=bx") which are related to the two generating equations of the map for
the
![(a,b)](https://s0.wp.com/latex.php?latex=%28a%2Cb%29&bg=ffffff&fg=333333&s=0
"(a,b)") corresponding to the above limit cycle curve is the attractor
point. The line
![y=bx](https://s0.wp.com/latex.php?latex=y%3Dbx&bg=ffffff&fg=333333&s=0
"y=bx") is the axis of symmetry of the map and the limit attractor
curve.

![henon\_one\_point\_trigonal](https://manasataramgini.files.wordpress.com/2016/12/henon_one_point_trigonal.png?w=640)Figure
3

Another case of the evolution of zero to a single point attractor via a
visually interesting map is generated in when
![a=-.5](https://s0.wp.com/latex.php?latex=a%3D-.5&bg=ffffff&fg=333333&s=0
"a=-.5") and values slightly greater than
![b=-1](https://s0.wp.com/latex.php?latex=b%3D-1&bg=ffffff&fg=333333&s=0
"b=-1"), e.g. (
![b=-.99995](https://s0.wp.com/latex.php?latex=b%3D-.99995&bg=ffffff&fg=333333&s=0
"b=-.99995")). Here the map assumes two oppositely directed pentagonal
regions with a prominent five-lobed region of exclusion. This attractor
point is specified by the higher point of intersection of the parabola
![x=1-ax^2+y](https://s0.wp.com/latex.php?latex=x%3D1-ax%5E2%2By&bg=ffffff&fg=333333&s=0
"x=1-ax^2+y") and the line
![y=bx](https://s0.wp.com/latex.php?latex=y%3Dbx&bg=ffffff&fg=333333&s=0
"y=bx") for the
![(a,b)](https://s0.wp.com/latex.php?latex=%28a%2Cb%29&bg=ffffff&fg=333333&s=0
"(a,b)") corresponding to the limit cycle curve formed when
![b=-1](https://s0.wp.com/latex.php?latex=b%3D-1&bg=ffffff&fg=333333&s=0
"b=-1") (in blue). This pattern reminiscent of structures emerging in
the Kolmogorov-Arnold-Mosser maps.

![henon\_one\_point\_pentagonal](https://manasataramgini.files.wordpress.com/2016/12/henon_one_point_pentagonal.png?w=640)Figure
4

Evolution of zero to a two point attractor is seen with parameters close
to ![a=.1; \\;
b=.9999](https://s0.wp.com/latex.php?latex=a%3D.1%3B+%5C%3B+b%3D.9999&bg=ffffff&fg=333333&s=0
"a=.1; \\; b=.9999"). At ![a=.8; \\;
b=1](https://s0.wp.com/latex.php?latex=a%3D.8%3B+%5C%3B+b%3D1&bg=ffffff&fg=333333&s=0
"a=.8; \\; b=1") the attractor becomes two closed curves which form the
outer limit of the earlier attractor (in blue).

![henon\_two\_point](https://manasataramgini.files.wordpress.com/2016/12/henon_two_point.png?w=640)Figure
5

Here again the two points of convergence are specified by the points of
intersection of the parabola
![-x=1-ax^2+y](https://s0.wp.com/latex.php?latex=-x%3D1-ax%5E2%2By&bg=ffffff&fg=333333&s=0
"-x=1-ax^2+y") and the line
![-y=bx](https://s0.wp.com/latex.php?latex=-y%3Dbx&bg=ffffff&fg=333333&s=0
"-y=bx") for
![(a,b)](https://s0.wp.com/latex.php?latex=%28a%2Cb%29&bg=ffffff&fg=333333&s=0
"(a,b)") corresponding to the limit curve, with the latter line being
axis of symmetry of the map.

![henon\_map](https://manasataramgini.files.wordpress.com/2016/12/henon_map.png?w=640)Figure
6

Zero also evolves to multi-point attractors, like a 6-point attractor at
![a=-.65; \\;
b=-.999199](https://s0.wp.com/latex.php?latex=a%3D-.65%3B+%5C%3B+b%3D-.999199&bg=ffffff&fg=333333&s=0
"a=-.65; \\; b=-.999199") and a 13 point attractor at ![a=-.65; \\;
b=-.9994142](https://s0.wp.com/latex.php?latex=a%3D-.65%3B+%5C%3B+b%3D-.9994142&bg=ffffff&fg=333333&s=0
"a=-.65; \\; b=-.9994142") (both shown together). The limit curve in
this case is broken up into 13 separate closed lobes.

![henon\_6\_13\_point](https://manasataramgini.files.wordpress.com/2016/12/henon_6_13_point.png?w=640)Figure
7

Given a pair of
![(a,b)](https://s0.wp.com/latex.php?latex=%28a%2Cb%29&bg=ffffff&fg=333333&s=0
"(a,b)") values, we can also study the number of iterations it takes for
points on the x,y plane to escape to infinity under the Henon map. Those
points which get trapped in and attractor are colored black while the
rest are color-coded according to the number of iterations they take to
escape. This produces interesting fractal structures with intricate
boundaries (the Henon equivalent of a Julia set). Examining these set we
see that in each case the successively diverging regions are a series of
nested parabolas that give way at their heart to a chaotic region that
looks like a pigment mixing in a fluid.
