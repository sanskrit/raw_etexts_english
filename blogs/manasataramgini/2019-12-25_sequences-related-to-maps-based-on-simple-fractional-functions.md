...
Here ![x\_n=0, \\dfrac{1}{1}, \\dfrac{3}{4}, \\dfrac{4}{5},
\\dfrac{15}{19}, \\dfrac{19}{24}, \\dfrac{72}{91}, \\dfrac{91}{115},
\\dfrac{345}{436},
\\dfrac{436}{551}...](https://s0.wp.com/latex.php?latex=x_n%3D0%2C+%5Cdfrac%7B1%7D%7B1%7D%2C+%5Cdfrac%7B3%7D%7B4%7D%2C+%5Cdfrac%7B4%7D%7B5%7D%2C+%5Cdfrac%7B15%7D%7B19%7D%2C+%5Cdfrac%7B19%7D%7B24%7D%2C+%5Cdfrac%7B72%7D%7B91%7D%2C+%5Cdfrac%7B91%7D%7B115%7D%2C+%5Cdfrac%7B345%7D%7B436%7D%2C+%5Cdfrac%7B436%7D%7B551%7D...&bg=ffffff&fg=333333&s=0
"x_n=0, \\dfrac{1}{1}, \\dfrac{3}{4}, \\dfrac{4}{5}, \\dfrac{15}{19}, \\dfrac{19}{24}, \\dfrac{72}{91}, \\dfrac{91}{115}, \\dfrac{345}{436}, \\dfrac{436}{551}...")

These are related to the sequence ![f\[n\]=f\[n-1\]+f\[n-3\];
f\[n+1\]=f\[n\]+f\[n-2\]; f\[n+2\]=3f\[n+1\]; f\[1\]=1, f\[2\]=1,
f\[3\]=3](https://s0.wp.com/latex.php?latex=f%5Bn%5D%3Df%5Bn-1%5D%2Bf%5Bn-3%5D%3B+f%5Bn%2B1%5D%3Df%5Bn%5D%2Bf%5Bn-2%5D%3B+f%5Bn%2B2%5D%3D3f%5Bn%2B1%5D%3B+f%5B1%5D%3D1%2C+f%5B2%5D%3D1%2C+f%5B3%5D%3D3&bg=ffffff&fg=333333&s=0
"f[n]=f[n-1]+f[n-3]; f[n+1]=f[n]+f[n-2]; f[n+2]=3f[n+1]; f[1]=1, f[2]=1, f[3]=3"):  
**1, 1, 3, 4, 5, 15, 19, 24, 72, 91, 115, 345, 436, 551…**

Now, one can use the substitution
![x\_n=y\_n-\\tfrac{1}{k}](https://s0.wp.com/latex.php?latex=x_n%3Dy_n-%5Ctfrac%7B1%7D%7Bk%7D&bg=ffffff&fg=333333&s=0
"x_n=y_n-\\tfrac{1}{k}") to convert our map into an equivalent but
alternative map:

![y\_{n+1}=\\dfrac{1}{k}\\left( 1+\\dfrac{1}{y\_n}
\\right)](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D%3D%5Cdfrac%7B1%7D%7Bk%7D%5Cleft%28+1%2B%5Cdfrac%7B1%7D%7By_n%7D+%5Cright%29&bg=ffffff&fg=333333&s=0
"y_{n+1}=\\dfrac{1}{k}\\left( 1+\\dfrac{1}{y_n} \\right)")

By writing
![y\_n=\\tfrac{w\_n}{w\_{n-1}}](https://s0.wp.com/latex.php?latex=y_n%3D%5Ctfrac%7Bw_n%7D%7Bw_%7Bn-1%7D%7D&bg=ffffff&fg=333333&s=0
"y_n=\\tfrac{w_n}{w_{n-1}}") the above map becomes a linear difference
equation:

![w\_{n+1}=\\dfrac{1}{k}(w\_n+w\_{n-1})](https://s0.wp.com/latex.php?latex=w_%7Bn%2B1%7D%3D%5Cdfrac%7B1%7D%7Bk%7D%28w_n%2Bw_%7Bn-1%7D%29&bg=ffffff&fg=333333&s=0
"w_{n+1}=\\dfrac{1}{k}(w_n+w_{n-1})")

Such a linear difference equation defines the quadratic equation:
![y^2-\\tfrac{y}{k}-\\tfrac{1}{k}=0](https://s0.wp.com/latex.php?latex=y%5E2-%5Ctfrac%7By%7D%7Bk%7D-%5Ctfrac%7B1%7D%7Bk%7D%3D0&bg=ffffff&fg=333333&s=0
"y^2-\\tfrac{y}{k}-\\tfrac{1}{k}=0") with roots:

![y=\\dfrac{1\\pm
\\sqrt{4k+1}}{2k}](https://s0.wp.com/latex.php?latex=y%3D%5Cdfrac%7B1%5Cpm+%5Csqrt%7B4k%2B1%7D%7D%7B2k%7D&bg=ffffff&fg=333333&s=0
"y=\\dfrac{1\\pm \\sqrt{4k+1}}{2k}")

Thus, the map in the variable
![y\_n](https://s0.wp.com/latex.php?latex=y_n&bg=ffffff&fg=333333&s=0
"y_n") will be attracted to the greater root ![\\tfrac{1+
\\sqrt{4k+1}}{2k}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1%2B+%5Csqrt%7B4k%2B1%7D%7D%7B2k%7D&bg=ffffff&fg=333333&s=0
"\\tfrac{1+ \\sqrt{4k+1}}{2k}") and repelled by the lesser root
![\\tfrac{1-
\\sqrt{4k+1}}{2k}](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B1-+%5Csqrt%7B4k%2B1%7D%7D%7B2k%7D&bg=ffffff&fg=333333&s=0
"\\tfrac{1- \\sqrt{4k+1}}{2k}") for any starting value of
![y\_n](https://s0.wp.com/latex.php?latex=y_n&bg=ffffff&fg=333333&s=0
"y_n"), except when ![y\_0=\\tfrac{1-
\\sqrt{4k+1}}{2k}](https://s0.wp.com/latex.php?latex=y_0%3D%5Ctfrac%7B1-+%5Csqrt%7B4k%2B1%7D%7D%7B2k%7D&bg=ffffff&fg=333333&s=0
"y_0=\\tfrac{1- \\sqrt{4k+1}}{2k}"); interesting aspects of the
convergence of this type of map was discussed
[earlier](https://manasataramgini.wordpress.com/2017/06/17/cobwebs-on-the-golden-hyperbola-and-parabola/).
Now, given that
![x\_n=y\_n-\\tfrac{1}{k}](https://s0.wp.com/latex.php?latex=x_n%3Dy_n-%5Ctfrac%7B1%7D%7Bk%7D&bg=ffffff&fg=333333&s=0
"x_n=y_n-\\tfrac{1}{k}"), we get the attractor
![A](https://s0.wp.com/latex.php?latex=A&bg=ffffff&fg=333333&s=0 "A") of
our original maps in
![x\_n](https://s0.wp.com/latex.php?latex=x_n&bg=ffffff&fg=333333&s=0
"x_n") to be:

![A=
\\dfrac{\\sqrt{4k+1}-1}{2k}](https://s0.wp.com/latex.php?latex=A%3D+%5Cdfrac%7B%5Csqrt%7B4k%2B1%7D-1%7D%7B2k%7D&bg=ffffff&fg=333333&s=0
"A= \\dfrac{\\sqrt{4k+1}-1}{2k}")

Now if ![k \<
-\\tfrac{1}{4}](https://s0.wp.com/latex.php?latex=k+%3C+-%5Ctfrac%7B1%7D%7B4%7D&bg=ffffff&fg=333333&s=0
"k \< -\\tfrac{1}{4}") then
![A](https://s0.wp.com/latex.php?latex=A&bg=ffffff&fg=333333&s=0 "A")
will be a complex number. Given that our original maps of the form
![x\_n=\\tfrac{1}{1+k
x\_{n-1}}](https://s0.wp.com/latex.php?latex=x_n%3D%5Ctfrac%7B1%7D%7B1%2Bk+x_%7Bn-1%7D%7D&bg=ffffff&fg=333333&s=0
"x_n=\\tfrac{1}{1+k x_{n-1}}") are defined in real space
![\\mathbb{R}](https://s0.wp.com/latex.php?latex=%5Cmathbb%7BR%7D&bg=ffffff&fg=333333&s=0
"\\mathbb{R}"), what will happen to the iterates in such a case?
Consider an example of
![k=-1](https://s0.wp.com/latex.php?latex=k%3D-1&bg=ffffff&fg=333333&s=0
"k=-1") and
![x\_0=-1](https://s0.wp.com/latex.php?latex=x_0%3D-1&bg=ffffff&fg=333333&s=0
"x_0=-1"). Here the map does not converge to a single attractor
![A](https://s0.wp.com/latex.php?latex=A&bg=ffffff&fg=333333&s=0 "A")
but cycles between 3 values: -1, 1/2, 2. Now, if we use a different
![x\_0=0](https://s0.wp.com/latex.php?latex=x_0%3D0&bg=ffffff&fg=333333&s=0
"x_0=0") we get 0, 1,
![\\infty](https://s0.wp.com/latex.php?latex=%5Cinfty&bg=ffffff&fg=333333&s=0
"\\infty"). Thus, the 3 values that the iterates cycle through depends
on ![x\_0](https://s0.wp.com/latex.php?latex=x_0&bg=ffffff&fg=333333&s=0
"x_0") but the cycle length is always
![3](https://s0.wp.com/latex.php?latex=3&bg=ffffff&fg=333333&s=0 "3").

Consider another case where
![k=-\\tfrac{1}{3}](https://s0.wp.com/latex.php?latex=k%3D-%5Ctfrac%7B1%7D%7B3%7D&bg=ffffff&fg=333333&s=0
"k=-\\tfrac{1}{3}") and
![x\_0=0](https://s0.wp.com/latex.php?latex=x_0%3D0&bg=ffffff&fg=333333&s=0
"x_0=0"). Here again the map does not converge to a single value but
cycles through 6 different values: 0, 1, 3/2, 2, 3,
![\\infty](https://s0.wp.com/latex.php?latex=%5Cinfty&bg=ffffff&fg=333333&s=0
"\\infty"). Again the cycle length is always 6 though the actual values
change with
![x\_0](https://s0.wp.com/latex.php?latex=x_0&bg=ffffff&fg=333333&s=0
"x_0"). This cycling in the above examples immediately suggests a
connection between the arithmetic operation of our map and trigonometry.
This connection becomes clear from the form
![A](https://s0.wp.com/latex.php?latex=A&bg=ffffff&fg=333333&s=0 "A")
takes:

If ![k\<-\\dfrac{1}{4}, \\; A=
-\\dfrac{1}{2k}+i\\dfrac{\\sqrt{-4k-1}}{2k}](https://s0.wp.com/latex.php?latex=k%3C-%5Cdfrac%7B1%7D%7B4%7D%2C+%5C%3B+A%3D+-%5Cdfrac%7B1%7D%7B2k%7D%2Bi%5Cdfrac%7B%5Csqrt%7B-4k-1%7D%7D%7B2k%7D&bg=ffffff&fg=333333&s=0
"k\<-\\dfrac{1}{4}, \\; A= -\\dfrac{1}{2k}+i\\dfrac{\\sqrt{-4k-1}}{2k}")

If we have a complex number
![z=x+iy](https://s0.wp.com/latex.php?latex=z%3Dx%2Biy&bg=ffffff&fg=333333&s=0
"z=x+iy") then it defines an angle
![\\theta=\\textrm{Arg}(z)=\\arctan\\left(\\tfrac{y}{x}\\right)](https://s0.wp.com/latex.php?latex=%5Ctheta%3D%5Ctextrm%7BArg%7D%28z%29%3D%5Carctan%5Cleft%28%5Ctfrac%7By%7D%7Bx%7D%5Cright%29&bg=ffffff&fg=333333&s=0
"\\theta=\\textrm{Arg}(z)=\\arctan\\left(\\tfrac{y}{x}\\right)") in the
complex plane. Thus we get the angle corresponding to
![A](https://s0.wp.com/latex.php?latex=A&bg=ffffff&fg=333333&s=0 "A") to
be:

![\\theta = \\textrm{Arg}(A)=
\\arctan\\left(-\\sqrt{-4k-1}\\right)](https://s0.wp.com/latex.php?latex=%5Ctheta+%3D+%5Ctextrm%7BArg%7D%28A%29%3D+%5Carctan%5Cleft%28-%5Csqrt%7B-4k-1%7D%5Cright%29&bg=ffffff&fg=333333&s=0
"\\theta = \\textrm{Arg}(A)= \\arctan\\left(-\\sqrt{-4k-1}\\right)")

Since for our purposes the sign of the angle does not matter we can work
with ![\\theta=
\\arctan\\left(\\sqrt{-4k-1}\\right)](https://s0.wp.com/latex.php?latex=%5Ctheta%3D+%5Carctan%5Cleft%28%5Csqrt%7B-4k-1%7D%5Cright%29&bg=ffffff&fg=333333&s=0
"\\theta= \\arctan\\left(\\sqrt{-4k-1}\\right)"). As an aside, we can
also express this angle as ![\\theta=
\\arccos\\left(\\tfrac{1}{2\\sqrt{-k}}\\right)](https://s0.wp.com/latex.php?latex=%5Ctheta%3D+%5Carccos%5Cleft%28%5Ctfrac%7B1%7D%7B2%5Csqrt%7B-k%7D%7D%5Cright%29&bg=ffffff&fg=333333&s=0
"\\theta= \\arccos\\left(\\tfrac{1}{2\\sqrt{-k}}\\right)").

Now when
![A](https://s0.wp.com/latex.php?latex=A&bg=ffffff&fg=333333&s=0 "A") is
real, ![\\theta =
\\textrm{Arg}(A)=\\pi](https://s0.wp.com/latex.php?latex=%5Ctheta+%3D+%5Ctextrm%7BArg%7D%28A%29%3D%5Cpi&bg=ffffff&fg=333333&s=0
"\\theta = \\textrm{Arg}(A)=\\pi"). Thus,
![\\tfrac{\\pi}{\\theta}=1](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B%5Cpi%7D%7B%5Ctheta%7D%3D1&bg=ffffff&fg=333333&s=0
"\\tfrac{\\pi}{\\theta}=1") and our map converges to a single value,
i.e. it has cycle length 1.

Instead, when say ![k=-1, \\; \\theta=
\\arctan\\left(\\sqrt{3}\\right)=\\tfrac{\\pi}{3}](https://s0.wp.com/latex.php?latex=k%3D-1%2C+%5C%3B+%5Ctheta%3D+%5Carctan%5Cleft%28%5Csqrt%7B3%7D%5Cright%29%3D%5Ctfrac%7B%5Cpi%7D%7B3%7D&bg=ffffff&fg=333333&s=0
"k=-1, \\; \\theta= \\arctan\\left(\\sqrt{3}\\right)=\\tfrac{\\pi}{3}").
Thus,
![\\tfrac{\\pi}{\\theta}=3](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B%5Cpi%7D%7B%5Ctheta%7D%3D3&bg=ffffff&fg=333333&s=0
"\\tfrac{\\pi}{\\theta}=3") and our map has cycle length 3. Similarly,
when ![k=-\\tfrac{1}{3}, \\; \\theta =
\\tfrac{\\pi}{6}](https://s0.wp.com/latex.php?latex=k%3D-%5Ctfrac%7B1%7D%7B3%7D%2C+%5C%3B+%5Ctheta+%3D+%5Ctfrac%7B%5Cpi%7D%7B6%7D&bg=ffffff&fg=333333&s=0
"k=-\\tfrac{1}{3}, \\; \\theta = \\tfrac{\\pi}{6}"). Thus,
![\\tfrac{\\pi}{\\theta}=6](https://s0.wp.com/latex.php?latex=%5Ctfrac%7B%5Cpi%7D%7B%5Ctheta%7D%3D6&bg=ffffff&fg=333333&s=0
"\\tfrac{\\pi}{\\theta}=6") and our map has a cycle length 6.

What if ![k](https://s0.wp.com/latex.php?latex=k&bg=ffffff&fg=333333&s=0
