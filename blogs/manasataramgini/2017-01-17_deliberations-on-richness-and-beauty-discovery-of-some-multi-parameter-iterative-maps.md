...
An attempt to understand the role of complexity in aesthetic experience
...
"a"), ![b](https://s0.wp.com/latex.php?latex=b&bg=ffffff&fg=333333&s=0
"b"), ![c](https://s0.wp.com/latex.php?latex=c&bg=ffffff&fg=333333&s=0
"c") are three constants. An examples are shown in Figure 1 and the map
is robust over a wide parameter range

![figure1\_small](https://manasataramgini.files.wordpress.com/2017/01/figure1_small.png?w=640)Figure
1

We modified versions of the Martin map into a more complex set of maps.
Map-1 works thus. The first mapping is similar to the Martin process:  
![x\_{n+1} = y\_n - sign(x\_n) \\cos \\left( \\dfrac{\\sqrt{|b x\_n -
c|} d}{2 \\pi} \\right) \\arctan \\left ( \\left (log\_l \\left (|c x\_n
- b| \\right ) \\right)^2
\\right)](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D+%3D+y_n+-+sign%28x_n%29+%5Ccos+%5Cleft%28+%5Cdfrac%7B%5Csqrt%7B%7Cb+x_n+-+c%7C%7D+d%7D%7B2+%5Cpi%7D+%5Cright%29+%5Carctan+%5Cleft+%28+%5Cleft+%28log_l+%5Cleft+%28%7Cc+x_n+-+b%7C+%5Cright+%29+%5Cright%29%5E2+%5Cright%29&bg=ffffff&fg=333333&s=0
"x_{n+1} = y_n - sign(x_n) \\cos \\left( \\dfrac{\\sqrt{|b x_n - c|} d}{2 \\pi} \\right) \\arctan \\left ( \\left (log_l \\left (|c x_n - b| \\right ) \\right)^2 \\right)")  
![y\_{n+1} = a -
x\_n](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D+%3D+a+-+x_n&bg=ffffff&fg=333333&s=0
"y_{n+1} = a - x_n")  
In place of
![\\cos()](https://s0.wp.com/latex.php?latex=%5Ccos%28%29&bg=ffffff&fg=333333&s=0
"\\cos()") in the first x-mapping we could also have
![\\sin()](https://s0.wp.com/latex.php?latex=%5Csin%28%29&bg=ffffff&fg=333333&s=0
"\\sin()").  
Then we subject
![(x\_{n+1},y\_{n+1})](https://s0.wp.com/latex.php?latex=%28x_%7Bn%2B1%7D%2Cy_%7Bn%2B1%7D%29&bg=ffffff&fg=333333&s=0
"(x_{n+1},y_{n+1})") to a further “affine” rotation before plotting
it:  
![x\_{n+1}=x\_{n+1} \\cos(k) - y\_{n+1}
\\sin(k)](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D%3Dx_%7Bn%2B1%7D+%5Ccos%28k%29+-+y_%7Bn%2B1%7D+%5Csin%28k%29&bg=ffffff&fg=333333&s=0
"x_{n+1}=x_{n+1} \\cos(k) - y_{n+1} \\sin(k)")  
![y\_{n+1}=x\_{n+1} \\sin(k) + y\_{n+1}
\\cos(k)](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D%3Dx_%7Bn%2B1%7D+%5Csin%28k%29+%2B+y_%7Bn%2B1%7D+%5Ccos%28k%29&bg=ffffff&fg=333333&s=0
"y_{n+1}=x_{n+1} \\sin(k) + y_{n+1} \\cos(k)")

Here we thus have 6 constants:
...
Map-2 works thus:  
![x\_{n+1}=y\_n-sign(x\_n) \\cos \\left ( \\dfrac {log\_{l1}(|b x\_n-c|)
d} {2 \\pi} \\right) \\arctan \\left(\\left(log\_{l2}\\left(|c
x\_n-b|\\right)\\right)^2\\right)](https://s0.wp.com/latex.php?latex=x_%7Bn%2B1%7D%3Dy_n-sign%28x_n%29+%5Ccos+%5Cleft+%28+%5Cdfrac+%7Blog_%7Bl1%7D%28%7Cb+x_n-c%7C%29+d%7D+%7B2+%5Cpi%7D+%5Cright%29+%5Carctan+%5Cleft%28%5Cleft%28log_%7Bl2%7D%5Cleft%28%7Cc+x_n-b%7C%5Cright%29%5Cright%29%5E2%5Cright%29&bg=ffffff&fg=333333&s=0
...
![y\_{n+1}=a-x\_n](https://s0.wp.com/latex.php?latex=y_%7Bn%2B1%7D%3Da-x_n&bg=ffffff&fg=333333&s=0
"y_{n+1}=a-x_n")  
In place of
![\\cos()](https://s0.wp.com/latex.php?latex=%5Ccos%28%29&bg=ffffff&fg=333333&s=0
"\\cos()") in the first x-mapping we could also have
...
The constants here are similar to those in the above map but we have one
extra one because we have two distinct logarithm terms. Finally in both
these maps replacing
![\\arctan()](https://s0.wp.com/latex.php?latex=%5Carctan%28%29&bg=ffffff&fg=333333&s=0
"\\arctan()") by the hyperbolic function
![\\tanh()](https://s0.wp.com/latex.php?latex=%5Ctanh%28%29&bg=ffffff&fg=333333&s=0
"\\tanh()") also produces interesting maps. Figures 2 and 3 respectively
show examples of each of the above maps.

![figure2\_small](https://manasataramgini.files.wordpress.com/2017/01/figure2_small.png?w=640)Figure
2 (First two with
![\\cos()](https://s0.wp.com/latex.php?latex=%5Ccos%28%29&bg=ffffff&fg=333333&s=0
"\\cos()") and second two with
![\\sin()](https://s0.wp.com/latex.php?latex=%5Csin%28%29&bg=ffffff&fg=333333&s=0
"\\sin()")

![figure3\_small](https://manasataramgini.files.wordpress.com/2017/01/figure3_small.png?w=640)Figure
3 (all maps use
![\\tanh()](https://s0.wp.com/latex.php?latex=%5Ctanh%28%29&bg=ffffff&fg=333333&s=0
"\\tanh()") in place of
![\\arctan()](https://s0.wp.com/latex.php?latex=%5Carctan%28%29&bg=ffffff&fg=333333&s=0
"\\arctan()") in Map-2; the third example uses
![\\sin()](https://s0.wp.com/latex.php?latex=%5Csin%28%29&bg=ffffff&fg=333333&s=0
"\\sin()").

These maps produce new forms of great beauty, diversity and richness of
