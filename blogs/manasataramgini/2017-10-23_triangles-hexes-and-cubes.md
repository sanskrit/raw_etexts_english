...
![T\_n=\\dfrac{n(n+1)}{2} \\rightarrow 1, 3, 6, 10, 15, 21, 28, 36, 45,
...
![cube\_cutting](https://manasataramgini.files.wordpress.com/2017/10/cube_cutting.png?w=640)Figure
...
![Hex\_cubes](https://manasataramgini.files.wordpress.com/2017/10/hex_cubes.png?w=640)Figure
9
...
![\\displaystyle \\sum\_{j=1}^n H\_j
=n^3](https://s0.wp.com/latex.php?latex=%5Cdisplaystyle+%5Csum_%7Bj%3D1%7D%5En+H_j+%3Dn%5E3&bg=ffffff&fg=333333&s=0
...
In conclusion, the study of figurate numbers might be seen as having
...
"y=\\sqrt{x}") is a generalization coming from the
![n](https://s0.wp.com/latex.php?latex=n&bg=ffffff&fg=333333&s=0 "n") as
the root of the square number
![n^2](https://s0.wp.com/latex.php?latex=n%5E2&bg=ffffff&fg=333333&s=0
"n^2"). Euler showed that similarly
![y](https://s0.wp.com/latex.php?latex=y&bg=ffffff&fg=333333&s=0 "y"), a
general triangular root of
![x](https://s0.wp.com/latex.php?latex=x&bg=ffffff&fg=333333&s=0 "x"),
can be defined as the solution of the quadratic equation
![y^2+y-2x=0](https://s0.wp.com/latex.php?latex=y%5E2%2By-2x%3D0&bg=ffffff&fg=333333&s=0
"y^2+y-2x=0"),  
![y=\\dfrac{\\sqrt{8x+1}-1}{2}](https://s0.wp.com/latex.php?latex=y%3D%5Cdfrac%7B%5Csqrt%7B8x%2B1%7D-1%7D%7B2%7D&bg=ffffff&fg=333333&s=0
"y=\\dfrac{\\sqrt{8x+1}-1}{2}")  
We get ![y](https://s0.wp.com/latex.php?latex=y&bg=ffffff&fg=333333&s=0
"y") to be an integer only when
![x=T\_n](https://s0.wp.com/latex.php?latex=x%3DT_n&bg=ffffff&fg=333333&s=0
"x=T_n"); then
![y=n](https://s0.wp.com/latex.php?latex=y%3Dn&bg=ffffff&fg=333333&s=0
"y=n"). Thus, only if
![\\sqrt{x}](https://s0.wp.com/latex.php?latex=%5Csqrt%7Bx%7D&bg=ffffff&fg=333333&s=0
"\\sqrt{x}") and its triangular root are simultaneously integers it is
both a square and a triangular number. In the below table we show the
first few numbers which are both triangular and square along with their
square root and triangular root.
...
From these numbers we can see that we can compose simultaneously square
and triangular numbers by the two seeded series:  
![S\[n\]=34\\cdot
S\[n-1\]-S\[n-2\]+2](https://s0.wp.com/latex.php?latex=S%5Bn%5D%3D34%5Ccdot+S%5Bn-1%5D-S%5Bn-2%5D%2B2&bg=ffffff&fg=333333&s=0
"S[n]=34\\cdot S[n-1]-S[n-2]+2"); where ![S\[0\]=0,
S\[1\]=1](https://s0.wp.com/latex.php?latex=S%5B0%5D%3D0%2C+S%5B1%5D%3D1&bg=ffffff&fg=333333&s=0
"S[0]=0, S[1]=1")

Similarly, the solution
![y](https://s0.wp.com/latex.php?latex=y&bg=ffffff&fg=333333&s=0 "y")
for the equation
![3y^2-3y+1-x=0](https://s0.wp.com/latex.php?latex=3y%5E2-3y%2B1-x%3D0&bg=ffffff&fg=333333&s=0
"3y^2-3y+1-x=0") provides the hex root of a number,  
![\\dfrac{3+\\sqrt{9-12(1-x)}}{6}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B3%2B%5Csqrt%7B9-12%281-x%29%7D%7D%7B6%7D&bg=ffffff&fg=333333&s=0
"\\dfrac{3+\\sqrt{9-12(1-x)}}{6}")

Table 2. First few numbers which are both triangular and hex numbers
with their triangular and hex roots.
...
Table 3. First few numbers which are both square and hex numbers and
their square and hex roots.
...
Whereas a square number is never prime and
![T\_2=3](https://s0.wp.com/latex.php?latex=T_2%3D3&bg=ffffff&fg=333333&s=0
"T_2=3") is the only prime triangular number, the general formula for
hex numbers is a fairly rich prime-generating  
quadratic. For instance there are 58 ![H\_n|
n\<10000](https://s0.wp.com/latex.php?latex=H_n%7C+n%3C10000&bg=ffffff&fg=333333&s=0
"H_n| n\<10000") of which 28 are prime:
![pf=0.4827586](https://s0.wp.com/latex.php?latex=pf%3D0.4827586&bg=ffffff&fg=333333&s=0
"pf=0.4827586"). For comparison we draw 58 numbers 10000 taking into
account the following: 1) hex numbers are always odd; 2) they are not
evenly distributed: the first 100 has 6 hex number while the next 100
has only 2. Thus, we make the clustering pattern of our draws identical
to that of hex numbers in windows of 100. Doing a simulation with these
constraints we get a probability of the prime fraction in draws of 58
numbers being
![pf=0.4827586](https://s0.wp.com/latex.php?latex=pf%3D0.4827586&bg=ffffff&fg=333333&s=0
