...
1\) Draw two unit squares sharing a common side
![\\overline{DB}](https://s0.wp.com/latex.php?latex=%5Coverline%7BDB%7D&bg=ffffff&fg=333333&s=0
"\\overline{DB}").  
2\) Bisect
![\\overline{DB}](https://s0.wp.com/latex.php?latex=%5Coverline%7BDB%7D&bg=ffffff&fg=333333&s=0
"\\overline{DB}") to get midpoint H. With H as center draw a circle of
radius 0.5  
3\) Draw
![\\overline{AF}](https://s0.wp.com/latex.php?latex=%5Coverline%7BAF%7D&bg=ffffff&fg=333333&s=0
"\\overline{AF}").
![\\overline{AF}](https://s0.wp.com/latex.php?latex=%5Coverline%7BAF%7D&bg=ffffff&fg=333333&s=0
"\\overline{AF}") cuts the circle at points I and J. Now
![\\overline{AJ}=\\phi](https://s0.wp.com/latex.php?latex=%5Coverline%7BAJ%7D%3D%5Cphi&bg=ffffff&fg=333333&s=0
"\\overline{AJ}=\\phi"). Also ![\\angle
BHA=\\tan^{-1}(2)](https://s0.wp.com/latex.php?latex=%5Cangle+BHA%3D%5Ctan%5E%7B-1%7D%282%29&bg=ffffff&fg=333333&s=0
"\\angle BHA=\\tan^{-1}(2)")  
From the construction we have:  
![\\overline{AJ}=\\overline{HJ}+\\sqrt{\\overline{AB}^2+\\overline{BH}^2}=\\dfrac{1}{2}+\\sqrt{1+\\dfrac{1}{4}}=\\phi](https://s0.wp.com/latex.php?latex=%5Coverline%7BAJ%7D%3D%5Coverline%7BHJ%7D%2B%5Csqrt%7B%5Coverline%7BAB%7D%5E2%2B%5Coverline%7BBH%7D%5E2%7D%3D%5Cdfrac%7B1%7D%7B2%7D%2B%5Csqrt%7B1%2B%5Cdfrac%7B1%7D%7B4%7D%7D%3D%5Cphi&bg=ffffff&fg=333333&s=0
"\\overline{AJ}=\\overline{HJ}+\\sqrt{\\overline{AB}^2+\\overline{BH}^2}=\\dfrac{1}{2}+\\sqrt{1+\\dfrac{1}{4}}=\\phi")

**Construction 2:**  
![golden\_3squares](https://manasataramgini.files.wordpress.com/2016/08/golden_3squares.png?w=640)

1\) Draw three unit squares with each adjacent one sharing a common
side.  
2\) Draw
![\\overline{ED}](https://s0.wp.com/latex.php?latex=%5Coverline%7BED%7D&bg=ffffff&fg=333333&s=0
"\\overline{ED}"). Note ![\\angle
BED=\\tan^{-1}(2)](https://s0.wp.com/latex.php?latex=%5Cangle+BED%3D%5Ctan%5E%7B-1%7D%282%29&bg=ffffff&fg=333333&s=0
"\\angle BED=\\tan^{-1}(2)"). Bisect ![\\angle
BED](https://s0.wp.com/latex.php?latex=%5Cangle+BED&bg=ffffff&fg=333333&s=0
"\\angle BED") to get point K.
![\\overline{AK}=\\phi](https://s0.wp.com/latex.php?latex=%5Coverline%7BAK%7D%3D%5Cphi&bg=ffffff&fg=333333&s=0
"\\overline{AK}=\\phi")  
From construction we have:  
![\\overline{ED}=\\sqrt{\\overline{BE}^2+\\overline{BD}^2}=\\sqrt{1+4}=\\sqrt{5}](https://s0.wp.com/latex.php?latex=%5Coverline%7BED%7D%3D%5Csqrt%7B%5Coverline%7BBE%7D%5E2%2B%5Coverline%7BBD%7D%5E2%7D%3D%5Csqrt%7B1%2B4%7D%3D%5Csqrt%7B5%7D&bg=ffffff&fg=333333&s=0
"\\overline{ED}=\\sqrt{\\overline{BE}^2+\\overline{BD}^2}=\\sqrt{1+4}=\\sqrt{5}")  
Using the angle bisector theorem we have:  
![\\dfrac{\\overline{BK}}{\\overline{DK}}=\\dfrac{\\overline{BE}}{\\overline{DE}}](https://s0.wp.com/latex.php?latex=%5Cdfrac%7B%5Coverline%7BBK%7D%7D%7B%5Coverline%7BDK%7D%7D%3D%5Cdfrac%7B%5Coverline%7BBE%7D%7D%7B%5Coverline%7BDE%7D%7D&bg=ffffff&fg=333333&s=0
"\\dfrac{\\overline{BK}}{\\overline{DK}}=\\dfrac{\\overline{BE}}{\\overline{DE}}").
Let ![\\overline{BK}=x\\; \\therefore
\\dfrac{x}{2-x}=\\dfrac{1}{\\sqrt{5}}](https://s0.wp.com/latex.php?latex=%5Coverline%7BBK%7D%3Dx%5C%3B+%5Ctherefore+%5Cdfrac%7Bx%7D%7B2-x%7D%3D%5Cdfrac%7B1%7D%7B%5Csqrt%7B5%7D%7D&bg=ffffff&fg=333333&s=0
"\\overline{BK}=x\\; \\therefore \\dfrac{x}{2-x}=\\dfrac{1}{\\sqrt{5}}")

![\\therefore x=\\dfrac{2}{1+\\sqrt{5}}=\\dfrac{1}{\\phi}\\therefore
\\overline{AK}=1+\\dfrac{1}{\\phi}=\\phi](https://s0.wp.com/latex.php?latex=%5Ctherefore+x%3D%5Cdfrac%7B2%7D%7B1%2B%5Csqrt%7B5%7D%7D%3D%5Cdfrac%7B1%7D%7B%5Cphi%7D%5Ctherefore+%5Coverline%7BAK%7D%3D1%2B%5Cdfrac%7B1%7D%7B%5Cphi%7D%3D%5Cphi&bg=ffffff&fg=333333&s=0
"\\therefore x=\\dfrac{2}{1+\\sqrt{5}}=\\dfrac{1}{\\phi}\\therefore \\overline{AK}=1+\\dfrac{1}{\\phi}=\\phi")

**Construction 3**  
![golden\_square\_triangle](https://manasataramgini.files.wordpress.com/2016/08/golden_square_triangle.png?w=640)

1\) Draw a square ABCD with sides of length 2 units.  
2\) Obtain midpoint E of
![\\overline{CD}](https://s0.wp.com/latex.php?latex=%5Coverline%7BCD%7D&bg=ffffff&fg=333333&s=0
"\\overline{CD}") and join it point A and B to obtain ![\\triangle ABE
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABE+&bg=ffffff&fg=333333&s=0
"\\triangle ABE "). Note ![\\angle
ABE=\\tan^{-1}(2)](https://s0.wp.com/latex.php?latex=%5Cangle+ABE%3D%5Ctan%5E%7B-1%7D%282%29&bg=ffffff&fg=333333&s=0
"\\angle ABE=\\tan^{-1}(2)")  
3\) Draw incircle of ![\\triangle ABE
](https://s0.wp.com/latex.php?latex=%5Ctriangle+ABE+&bg=ffffff&fg=333333&s=0
"\\triangle ABE ") having determined incenter I. It touches
![\\overline{AB}](https://s0.wp.com/latex.php?latex=%5Coverline%7BAB%7D&bg=ffffff&fg=333333&s=0
"\\overline{AB}") at F.  
4\) Using
![\\overline{FI}](https://s0.wp.com/latex.php?latex=%5Coverline%7BFI%7D&bg=ffffff&fg=333333&s=0
"\\overline{FI}") as radius and F as center draw another circle to
obtain point J.
![\\overline{AJ}=\\phi](https://s0.wp.com/latex.php?latex=%5Coverline%7BAJ%7D%3D%5Cphi&bg=ffffff&fg=333333&s=0
"\\overline{AJ}=\\phi").  
From construction we have:  
![\\overline{AE}=\\overline{BE}=\\sqrt{5}\\; \\therefore
perimeter(\\triangle
ABE)=2+2\\sqrt{5}](https://s0.wp.com/latex.php?latex=%5Coverline%7BAE%7D%3D%5Coverline%7BBE%7D%3D%5Csqrt%7B5%7D%5C%3B+%5Ctherefore+perimeter%28%5Ctriangle+ABE%29%3D2%2B2%5Csqrt%7B5%7D&bg=ffffff&fg=333333&s=0
"\\overline{AE}=\\overline{BE}=\\sqrt{5}\\; \\therefore perimeter(\\triangle ABE)=2+2\\sqrt{5}")

Radius of incircle
![r\_i=\\sqrt{\\dfrac{(1+\\sqrt{5}-\\sqrt{5})(1+\\sqrt{5}-\\sqrt{5})(\\sqrt{5}-1)}{1+\\sqrt{5}}}=\\dfrac{1}{\\phi}](https://s0.wp.com/latex.php?latex=r_i%3D%5Csqrt%7B%5Cdfrac%7B%281%2B%5Csqrt%7B5%7D-%5Csqrt%7B5%7D%29%281%2B%5Csqrt%7B5%7D-%5Csqrt%7B5%7D%29%28%5Csqrt%7B5%7D-1%29%7D%7B1%2B%5Csqrt%7B5%7D%7D%7D%3D%5Cdfrac%7B1%7D%7B%5Cphi%7D&bg=ffffff&fg=333333&s=0
"r_i=\\sqrt{\\dfrac{(1+\\sqrt{5}-\\sqrt{5})(1+\\sqrt{5}-\\sqrt{5})(\\sqrt{5}-1)}{1+\\sqrt{5}}}=\\dfrac{1}{\\phi}")  
![\\therefore \\;
\\overline{AJ}=\\phi](https://s0.wp.com/latex.php?latex=%5Ctherefore+%5C%3B+%5Coverline%7BAJ%7D%3D%5Cphi&bg=ffffff&fg=333333&s=0
"\\therefore \\; \\overline{AJ}=\\phi")

A construction such as these can be also used to easily construct a
...
![golden\_buddha](https://manasataramgini.files.wordpress.com/2016/08/golden_buddha.jpg?w=640)
